    ...
    <footer>
        ...
        <div style={{
            ...
            <div style={{ display:'flex', gap: '20px' }}>
                <Link to="/login" style={{ color: 'black', }} >이용약관</Link>
                <Link to="/login" style={{ color: 'black', fontWeight: 'bold'}} >개인정보처리방침</Link>
                <Link to="/login" style={{ color: 'black', }} >오시는 길</Link>
                <Link to="/login" style={{ color: 'black', }} >FAQ</Link>
                <Link to="/login" style={{ color: 'black', }} >문의하기</Link>
            </div>

            {/* 회사 정보 */}
            <div>
                <p style={{ margin: '0 0 5px 0', color: 'rgb(155, 155, 155)' }}>
                회사명: 배우다(주)  대표: 홍지원, 이주영  사업자등록번호 123-45-67890
                서울시 영등포구 여의도동 12-3 빌딩
                </p>
                <p style={{ margin: 0, color: 'rgb(155, 155, 155)' }}>
