          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '30px' }}>
            ...
            <nav>
              <ul style={{ display: 'flex', listStyle: 'none', padding: 0, margin: 0 }}>
                ...
                <li>
                  <button onClick={handleEventClick} style={{
                    background: 'none',
                    border: 'none',
                    color: 'black',
                    fontSize: '16px',
        ...
        <AuthLinks>
          ...
          {user ? (
            ...
            <div style={{ display: 'flex', gap: '10px' }}>
              <StyledLink to="/auth?mode=login" style={{ fontSize: '14px', color: 'black', padding: '5px 15px', textDecoration: 'none' }}>로그인</StyledLink>
