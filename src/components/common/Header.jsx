...
const [hoveredCategory, setHoveredCategory] = useState(null);
  ...
  return (
    ...
    >
      ...
      {/* 하단 카테고리 */}
      <nav style={{ width: '100%', margin: '0 auto', height: '49px',borderBottom: '1px solid #ebebeb', borderRadius: '10px' }}>
        <ul
          style={{
            maxWidth: '1350px',
            margin: '0 auto',
            ...
            <li key={mainCategory}>
              <button
                ...
                style={{
                  ...
                  fontWeight: '550',
                  cursor: 'pointer',
                  color: hoveredCategory === mainCategory ? 'rgb(153, 153, 153)' : 'rgb(100, 100, 100)', 
