...
const CoursedetailPage = () => {
  ...
  const { desc, image, level, day, time } = location.state || {};
       ...
       <aside style={{ flex: 1 }}>
          ...
          >
            ...
            <div style={{ position: 'relative', borderRadius: '10px 10px 0 0', overflow: 'hidden', filter: 'brightness(0.89) contrast(1.05)' }}>
              ...
              >
                <div style={{ fontSize: '14px', zIndex: '2' }}>왕초보도 가능한</div>
                <div style={{ fontSize: '20px', fontWeight: 'bold', zIndex: '2' }}>파이썬 입문</div>
              </div>
            </div>

            {/* 가격 */}
            <div style={{ padding: '23px 20px 15px', borderBottom: '1px solid #eee' }}>
              <div
                style={{
                  fontSize: '14px',
                  color: '#999',
              ...
              <div style={{ fontSize: '24px', fontWeight: 'bold', color: '#000' }}>₩175,000</div>
            </div>
