...
const AuthPage = () => {
  ...
  return (
    <div style={styles.container}>
      ...
      <button onClick={() => navigate('/')} style={styles.home}><img src="/icons/home.svg" alt="홈" style={styles.arrow}/></button>
      ...
      <div style={styles.rightSection}>
        {activeForm === 'login' && <Login onSwitch={handleSwitch} />}
        {activeForm === 'find-id' && <FindId onSwitch={handleSwitch} />}
