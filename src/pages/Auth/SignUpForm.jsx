...
const SignupForm = () => {
  ...
  return (
    <div style={{ maxWidth: '320px', margin: '0 auto', fontFamily: 'sans-serif', position: 'relative' }}>
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div style={{ display: 'flex', gap: '5px', position: 'relative' }}>
          ...
          <button
            ...
            disabled={!formData.email.includes('@') || emailButtonDisabled}
            style={createButtonStyle(formData.email.includes('@') && !emailButtonDisabled)}
          >
            인증번호 전송
          </button>
        ...
        <div style={{ display: 'flex', gap: '5px' }}>
          ...
          <button
            ...
            disabled={!formData.verificationCode.trim() || codeButtonDisabled || codeSubmitted}
            style={createButtonStyle(formData.verificationCode.trim() && !codeButtonDisabled && !codeSubmitted)}
          >
            인증번호 확인
          </button>
        </div>
        ...
        <button
          ...
          style={{
            ...baseButtonStyle,
            backgroundColor: isFormValid ? '#d04444' : '#ccc',
            marginTop: '16px',
      ...
      <div style={{ display: 'flex', gap: '6px', marginTop: '8px', width: '100%', justifyContent: 'center' }}>
        <p style={{ color: 'rgb(153, 153, 153)', fontSize: '13.5px', margin: '0 0' }}>
          이미 가입된 계정이 있으신가요?
        </p>
        <Link to="/auth?mode=login" style={{ color: 'rgb(106, 109, 117)', fontSize: '13.5px', fontWeight: 'bold', textDecoration: 'underline' }}>
          로그인
        </Link>
      </div>
    </div>
