        ...
        <aside
          ...
          >
           ...
           <div style={{ fontSize: '14px', color: '#444', margin: '20px 0', display: 'flex', alignItems: 'center', gap: '10px' }}>
            ...
            {overlaySub || course?.author || '강사명'}
          </div>

          <div style={{ marginBottom: '15px' }}>
            {course?.options &&
              Object.entries(course.options).map(([optionName, { price, originalPrice }]) => (
                <button
                  key={optionName}
                  ...
                  style={{
                    ...
                    fontWeight: 'bold',
                    borderRadius: '8px',
                    border: selectedOption === optionName ? '2px solid #E57373' : '2px solid #ccc',
                    backgroundColor: selectedOption === optionName ? '#FFF3F3' : '#fff',
                    marginBottom: '7px',
                    cursor: 'pointer',
                  }}
                >
                  <div style={{ display: 'flex', justifyContent: 'space-between' }}>
                    ...
                    <span>
                      <span style={{ textDecoration: 'line-through', color: '#aaa', marginRight: '5px' }}>{originalPrice}</span>
                ...
                return (
                  <button
                    ...
                    onClick={() => {
                      ...
                      if (label === '공유하기') console.log('공유하기 클릭');
                    }}
                    style={{
                      display: 'flex',
